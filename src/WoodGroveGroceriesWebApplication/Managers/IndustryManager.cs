namespace WoodGroveGroceriesWebApplication.Managers
{
    ...
    public class IndustryManager
    {
        ...
        //Add to the initial project
        private IConfiguration _configuration;

        public IndustryManager(HostService host, IConfiguration configuration )
        {
            _host = host;
        ...
        public Industry SetIndustry(HttpRequest request)
        {
            ...
            var configuredIndustry = _configuration["Industry"]; // ;
            if (string.IsNullOrEmpty(configuredIndustry))
            {
                configuredIndustry = request.Cookies[Constants.DemoCookies.IndustryKey].ToBase64Decode();
            }
